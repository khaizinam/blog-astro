...
1\. [Bản chất React và Virtual DOM](#vi-rx1)

2\. [Câu hỏi về Hooks — useState, useEffect, useCallback, useMemo](#vi-rx2)

3\. [Câu hỏi về State và Props](#vi-rx3)

4\. [Câu hỏi về Component lifecycle và re-render](#vi-rx4)

5\. [Câu hỏi về State management — Context vs Redux](#vi-rx5)

6\. [Case study thực tế](#vi-rx6)

7\. [Sai lầm phổ biến khi trả lời câu hỏi ReactJS](#vi-rx7)

8\. [Hỏi đáp nhanh](#vi-rx8)
