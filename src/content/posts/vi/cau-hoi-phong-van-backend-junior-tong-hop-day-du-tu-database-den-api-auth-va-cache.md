...
1\. [Bản chất của phỏng vấn backend junior](#ban-chat-cua-phong-van-backend-junior)

2\. [Nhóm câu hỏi về REST API và thiết kế API](#nhom-cau-hoi-ve-rest-api-va-thiet-ke-api)

3\. [Nhóm câu hỏi về Database và SQL](#nhom-cau-hoi-ve-database-va-sql)

4\. [Nhóm câu hỏi về Authentication và bảo mật](#nhom-cau-hoi-ve-authentication-va-bao-mat)

5\. [Nhóm câu hỏi về Caching và hiệu năng](#nhom-cau-hoi-ve-caching-va-hieu-nang)

6\. [Case study: buổi phỏng vấn backend thực tế](#case-study-buoi-phong-van-backend-thuc-te)

7\. [Sai lầm phổ biến khi trả lời câu hỏi backend](#sai-lam-pho-bien-khi-tra-loi-cau-hoi-backend)
