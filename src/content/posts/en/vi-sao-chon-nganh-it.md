...
tags:
  - "SeriesPhongVan"
description: "A practical guide to answering \"Why did you choose IT?\" in job interviews - what HR is actually evaluating, a 3-part framework for building your answer, script templates for freshers and career changers, and the common mistakes that make this answer sound hollow and unconvincing."
---
...
*   [1\. What HR Is Actually Measuring With This Question](#1-what-hr-is-actually-measuring-with-this-question)
*   [2\. Before & After: What a Structured Answer Looks Like](#2-before-after-what-a-structured-answer-looks-like)
*   [3\. The SMD Framework for Building Your Answer](#3-the-smd-framework-for-building-your-answer)
*   [4\. Script Templates by Situation](#4-script-templates-by-situation)
...
_"I chose IT because I've always liked computers and I think there are a lot of opportunities in this field. The salary is good too. I think it's a good fit for me and I want to grow in this industry long-term."_
...
\[Movement - active step, 1 sentence\]
...
\[Spark - what was missing + what IT filled, 2 sentences\]
"I spent \[X\] years working in \[previous field\]. What I
...
\[Direction - focus within IT, 1 sentence\]
"I want to go into \[specific direction\] because
\[connection to experience from previous field if relevant\]."
...
Primarily in the HR screening round or at the beginning of a culture fit round. Tech leads occasionally ask a variation: "When did you start programming?" - which is structurally the same question. Prepare one answer that works naturally for both phrasings. See [10 IT Fresher Interview Questions You'll Actually Face](/en/10-cau-hoi-phong-van-fresher-it-hay-gap-nhat-ban-can-chuan-bi) to prepare the behavioral questions that typically appear in the same round.
